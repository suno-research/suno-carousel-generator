...
Stack: **Vercel** (frontend) + **Render** (backend). Sem autenticação — qualquer um com a URL pode usar. Mantenha o link privado (não divulgue).
...
4. **Environment variables**:
   - `NEXT_PUBLIC_BACKEND_URL` — URL do Render do passo 1
